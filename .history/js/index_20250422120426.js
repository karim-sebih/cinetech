...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    displayItems(moviesContainer, movies, movies.length, 'movie'); // Tous les films disponibles (20)
    displayItems(seriesContainer, series, series.length, 'tv'); // Toutes les séries disponibles (20)
